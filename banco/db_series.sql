...
-- Copiando estrutura para tabela bd_series.serie
...
-- Copiando dados para a tabela bd_series.serie: ~16 rows (aproximadamente)
DELETE FROM `serie`;
/*!40000 ALTER TABLE `serie` DISABLE KEYS */;
INSERT INTO `serie` (`Id`, `Nome`, `Descricao`, `ImgPoster`, `Ano`) VALUES
...
/*!40000 ALTER TABLE `seriejavista` DISABLE KEYS */;
/*!40000 ALTER TABLE `seriejavista` ENABLE KEYS */;
